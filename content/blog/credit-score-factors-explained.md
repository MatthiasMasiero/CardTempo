...
| Utilization | Score Impact | Example |
|-------------|--------------|---------|
| 0-9% | Optimal | 800-850 range |
| 10-29% | Good | 740-799 range |
| 30-49% | Fair | -40 to -70 pts |
| 50-74% | Poor | -70 to -100 pts |
| 75-100% | Very Poor | -100 to -150 pts |
...
**Why 0% isn't optimal:**
Credit scoring models want to see you **actively using credit responsibly**. Having small balances (under 10%) shows you use credit but don't depend on it.

**When it's calculated:**
This is the critical detail most people miss:

❌ **NOT on your due date**
✅ **On your statement closing date**
...
**The fix:**
Pay your balance down **BEFORE the statement closing date** to report lower utilization.
...
**Fastest score boost:**
Going from 50% utilization to 10% can increase your score **40-100 points in 30 days**. This is the quickest win.
...
|-------------|--------------|
| 10+ years | Optimal |
| 7-10 years | Very Good |
| 4-7 years | Good |
| 2-4 years | Fair |
| Under 2 years | Poor (limited) |
...
If your parent has a 15-year-old card, becoming an authorized user adds that 15-year history to your report. This can increase your average age by **years instantly**.
...
|------------|--------------|
| Cards + installment loans | Optimal |
| Only cards (no loans) | -10 to -20 points |
| Only loans (no cards) | -10 to -20 points |
| Very thin file (1-2 accounts) | -20 to -40 points |
...
**Only difference:** Utilization
**Score difference:** 70 points
...
1. **Credit utilization** ← Focus here first
2. **New inquiries** (stop applying)
3. **Dispute errors**

### Take Time to Build:
1. **Payment history** (7 years to recover from late payment)
2. **Credit age** (can't speed up time)
3. **Credit mix** (6-12 months to see impact)
...
❌ **Your job** (not in FICO calculation)
❌ **Checking your own credit** (soft inquiry)
❌ **Getting pre-qualified** (soft inquiry)
❌ **Debit card usage** (not credit)
❌ **Utility/phone bills** (unless sent to collections)
❌ **Rent payments** (unless using rent-reporting service)

## The 80/20 Rule for Credit Scores

**80% of your score improvement** will come from:
1. Optimizing credit utilization (under 10%)
2. Never missing payments (set autopay)

**The remaining 20%** comes from:
3. Building credit age (keep old accounts open)
4. Limiting new inquiries
5. Maintaining credit mix
...
**Example report:**
1. "Balances on revolving accounts too high" → Fix utilization
2. "Too many accounts with balances" → Pay some cards to $0
3. "Length of credit history too short" → Keep old accounts open, consider authorized user
4. "Too many recent inquiries" → Stop applying for credit

**Prioritize fixing factors in this order:**
1. Utilization (fastest improvement)
2. Payment setup (prevent future damage)
3. Dispute errors (30-45 days)
4. Everything else (long-term)

## Your Action Plan

### This Week:
1. **Get your credit report** (AnnualCreditReport.com)
2. **Calculate your utilization** (balances / limits)
3. **Set up autopay** on all accounts
4. **Find your statement closing dates**

### This Month:
5. **Make payments before closing dates** to optimize utilization
6. **Dispute any errors** found on your report
7. **Request credit limit increases**

### This Quarter:
8. **Get utilization under 10%** (all cards)
9. **Keep oldest accounts active** (small charge every 6 months)
10. **Monitor score monthly** (free tools like Credit Karma)

### This Year:
11. **Maintain sub-10% utilization** consistently
12. **Perfect payment history** (via autopay)
13. **Strategic authorized user** or **credit builder loan** (if needed)

## The Bottom Line

**Five factors determine your FICO score:**

1. **Payment History (35%):** Never miss payments (autopay!)
2. **Credit Utilization (30%):** Keep under 10%, pay before closing dates ← Quickest boost
3. **Credit History (15%):** Keep old accounts open
4. **Credit Mix (10%):** Have both cards and installment loans
5. **New Credit (10%):** Limit applications
